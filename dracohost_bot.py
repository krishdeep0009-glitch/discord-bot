...
def provision(vps_id, image, os_label, ram_mb, cpu_cores, disk_gb, cpu_name, gpu_name=None) -> tuple:
    ...
    if gpu_name:
        ...
        nvidia_smi_script = (
            ...
            'echo "|=================================================================================|"\n'
            f'echo "|   0  {gpu_name:<22}  Off  |   00000000:01:00.0  Off |                  N/A |"\n'
            'echo "| 30%   35C    P8              12W / 220W|      0MiB / '
            f'{vram_mb}MiB |      0%      Default |"\n'
            'echo "|                                         |                       |                  N/A |"\n'
            'echo "+-----------------------------------------------------------------------------+"\n'
            'echo\n'
            'echo "+-----------------------------------------------------------------------------+"\n'
        ...
        log.info(f"[{vps_id}] nvidia-smi faked ({gpu_name}, {vram_mb}MiB VRAM)")
